...
use crate::auxiliar::error::{AssemblerError, Stage::MathematicalBoundChecking};

pub(crate) fn i128_to_u8(x: i128) -> Result<u8, AssemblerError> {
...
pub(crate) fn i128_to_i16(x: i128) -> Result<i16, AssemblerError> {
...
pub(crate) fn i128_to_i32(x: i128) -> Result<i32, AssemblerError> {
...
pub(crate) fn interpret_literal(value: &str) -> Result<i128, ParseIntError> {
